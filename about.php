...
<section class="about py-5">
	<div class="container py-sm-3">
		<h1 class="heading mb-lg-5 mb-4">A propos du groupe</h1>
		<div class="row about-grids">
				 ...
				 les services divers aupres des entreprises et des particiliers.<br>
				  Situé a Paris , France il oeuvre dans les domaines suivants :
					...
					<ul class="list-unstyled quick-links">
						<li ><p  href="javascript:void();"> <h5 style="color:#30c39e;" ><i class="fa fa-angle-double-right"></i> sécurité et surété</h5></p></li>
			...
			<div class="col-lg-4 col-8 pr-sm-3 pr-0">
				<img src="images/pdg.jpg" class="img-fluid" alt="" />
				<div class="tag text-center mb-3 ">Sylvin Eric Kombi , PDG du groupe</div>
